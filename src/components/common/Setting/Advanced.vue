...
const systemKey = ref(settingStore.systemKey ?? '')
  ...
  <div class="p-4 space-y-5 min-h-[200px]">
    <div class="space-y-6">
      <div class="flex items-center space-x-4">
        ...
        <div class="flex-1">
          <NInput v-model:value="systemKey" type="text" placeholder="请输入访问OpenAI的key" />
        </div>
        <NButton size="tiny" text type="primary" @click="updateSettings({ systemKey })">
          {{ $t('common.save') }}
        </NButton>
      </div>
      <div class="flex items-center space-x-4">
